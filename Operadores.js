...
3 == "3"; //Compara los valores y devuelve "true" en este caso, no valida el tipo, sino el valor

3 === "3"; //Compara y valida los tipos y valores. Devuelve "falso" en este caso, valida tipo y valor.
